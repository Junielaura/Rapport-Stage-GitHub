...
switch (NUM_PAGE) {
    ...
    case 2:
        ...
        if ((isset($erreurprod)) && ($erreurprod)) {
            $pag = 'micropages/Utilisateurs/editer_profil/edit_profilutilisateur';
            $stag = 1;
            die('<meta http-equiv="refresh" content="0; URL='.indexadmin.php.'?page=' . base64_encode($pag) . '&pagecom=' . $stag . '">');
            
        } else {
        require('micropages/Utilisateurs/editer_profil/form_profilterminer.php');
        break;
        }
    ...
    default:
        ...
        require('micropages/Utilisateurs/editer_profil/form_edit_profilutilisateur.php');
        break;
}
}