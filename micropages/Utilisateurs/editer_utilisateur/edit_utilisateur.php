    ...
    switch (NUM_PAGE) {
        ...
        case 2:
            ...
            if ((isset($erreurprod)) && ($erreurprod)) {
                $pag = 'micropages/Utilisateurs/editer_utilisateur/edit_utilisateur';
                $stag = 1;
                die('<meta http-equiv="refresh" content="0; URL=' .  $url  . php . '?page=' . base64_encode($pag) . '&pagecom=' . $stag . '">');
            } else {
                require('micropages/Utilisateurs/editer_utilisateur/form_terminer.php');
                break;
            }
        ...
        default:
            ...
            require('micropages/Utilisateurs/editer_utilisateur/form_edit_utilisateur.php');
            break;
    }
}