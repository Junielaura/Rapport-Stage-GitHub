                    ...
                    <div class="sparkline12-list mt-b-30">
                        <div class="sparkline12-hd">
                            <div class="main-sparkline12-hd">
                                <center> <h1><strong>Formulaire de modification d'un Utilisateur</strong></h1> </center>
                            </div>
                        </div>
                        <form id="edit_utilisateur" name="formutilisateure" enctype="multipart/form-data" method="post" action="<?= $url; ?>?page=<?php echo base64_encode('micropages/Utilisateurs/editer_utilisateur/edit_utilisateur'); ?>&idutilisateur=<?php echo $_REQUEST["idutilisateur"]; ?>&pagecom=<?php echo NUM_PAGE + 1; ?>" style="padding: 2%;">
                                        ...
                                        <div class="inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="rolee" id="rolee">
                                                    ...
                                                    <option value="caissiere" <?php if ($_SESSION['formutilisateure'][NUM_PAGE]["rolee"] == "caissiere") { ?> selected <?php } ?>>caissiere</option>
                                                    ...
                                                    <option value="Agent de crédit" <?php if ($_SESSION['formutilisateure'][NUM_PAGE]["rolee"] == "Agent de credit") { ?> selected <?php } ?>>Agent de credit</option>
                                                    <option value="service client" <?php if ($_SESSION['formutilisateure'][NUM_PAGE]["rolee"] == "service client") { ?> selected <?php } ?>>service client</option>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-4">
                                    <div class="form-group">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            ...
                                            <img src="microupload/profil/<?php echo $_SESSION['formutilisateure'][NUM_PAGE]['photostring']; ?>" style="width: 20mm; height: 20mm;">
                ...
                pass1e: {
                    validators: {
                        ...
                        remote: {
                            ...
                            data: {idutilisateur: idutilisateur},
                            dataType: 'json',
                            url: './smicropages/Utilisateurs/remoteformvalidation_utilisateur.php',
