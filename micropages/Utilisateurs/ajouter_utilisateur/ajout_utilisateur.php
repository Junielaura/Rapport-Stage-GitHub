...
//                'departement' => trim(htmlspecialchars($_POST["departement"])),
        ...
        if ((isset($erreurprod)) && ($erreurprod)) {
            $pag = 'micropages/Utilisateurs/ajouter_utilisateur/ajout_utilisateur';
            $stag = 1;
            die('<meta http-equiv="refresh" content="0; URL='.$url .'?page=' . base64_encode($pag) . '&pagecom=' . $stag . '">');
            
        } else {
        require('micropages/Utilisateurs/ajouter_utilisateur/formterminer_utilisateur.php');
        break;
        }
    ...
    default:
        ...
        require('micropages/Utilisateurs/ajouter_utilisateur/formajout_utilisateur.php');
        break;
}