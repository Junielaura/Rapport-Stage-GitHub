                    ...
                    <div class="sparkline12-list mt-b-30">
                        <div class="sparkline12-hd">
                            <div class="main-sparkline12-hd">
                                <center> <h1> <strong>Formulaire d'ajout d'un utilisateur</strong></h1> </center>
                            </div>
                        </div>
                        <form id="ajout_pays" name="formutilisateur" enctype="multipart/form-data" method="post" action="<?= $url; ?>?page=<?php echo base64_encode('micropages/Utilisateurs/ajouter_utilisateur/ajout_utilisateur'); ?>&pagecom=<?php echo NUM_PAGE + 1; ?>" style="padding: 2%;">
                                        ...
                                        <div class="inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="role" id="role">
                                                    ...
                                                    <option value="administrateur" <?php if ($_SESSION['formutilisateur'][NUM_PAGE]["role"] == "administrateur") { ?> selected <?php } ?>>Administrateur</option>
                                                    <option value="Caissiere" <?php if ($_SESSION['formutilisateur'][NUM_PAGE]["role"] == "Caissiere") { ?> selected <?php } ?>>Caissiere</option>
                                                    <option value="Agent de credit" <?php if ($_SESSION['formutilisateur'][NUM_PAGE]["role"] == "Agent de credit") { ?> selected <?php } ?>>Agent credit</option>
                                                    <option value="service client" <?php if ($_SESSION['formutilisateur'][NUM_PAGE]["role"] == "service client") { ?> selected <?php } ?>>Directeur des ressources humaines</option>
                                                    <option value="Directeur des ressources humaines" <?php if ($_SESSION['formutilisateur'][NUM_PAGE]["role"] == "Directeur des ressources humaines") { ?> selected <?php } ?>>Directeur Général</option>
                                                    <option value="Directeur Général" <?php if ($_SESSION['formutilisateur'][NUM_PAGE]["role"] == "client") { ?> selected <?php } ?>>Client</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
