        ...
        <div class="panel panel-warning">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-3 col-xs-3">
                    <img class="img-rounded" style="width: 100%;" src="microupload/profil/<?php print nl2br(htmlspecialchars($recuser["photouser"])); ?>"> 
                </div>
            ...
            <div class="panel-footer"><br>
                ...
                &nbsp;&nbsp;
                <a href="<?= $url; ?>?page=<?php echo base64_encode('micropages/Utilisateurs/editer_profil/edit_profilutilisateur'); ?>&idutilisateur=<?php echo $recuser["iduser"]; ?>" class="btn btn-info">
